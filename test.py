...
messages = graph.invoke({"msg": "hello!"})
print(f"Query: hello1 \n Response: {messages['msg']}")

inputdata = {"msg": f"What is the currency of japan?"}
messages = graph.invoke(inputdata)
print(f"Query: {inputdata['msg']} \n Response: {messages['msg']}")
...
inputdata = {"msg": f"Summarize the context in 2 lines: {article}"}
messages = graph.invoke(inputdata)
print(f"Query: {inputdata['msg']} \n Response: {messages['msg']}")
